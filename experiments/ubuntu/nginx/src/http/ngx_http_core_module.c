...
ngx_http_core_root(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    uids_log("Setting up clcf->named");
    ...
    uids_log("Args strstr");

    value = cf->args->elts;

    uids_log(value[1].data);
